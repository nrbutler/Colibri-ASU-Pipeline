#!/usr/bin/python3
"""
grab_ps1_local.py fits_file outfile ra dra dec ddec
"""

import sys,os
from astropy.io.fits import getdata,writeto
from numpy import array,vstack,sqrt,exp,searchsorted
...
def grab_ps1_local(fitsfile,outfile,ra1,ra2,dec1,dec2):
    """
    """
    ...
    dm = sqrt( 1.05e-3*exp(1.39*(data[2]-20.25))+4.e-6 )
    writeto(outfile, vstack((data,dm)) )
...
def main():
    ...
    grab_ps1_local(fits_file,outfile,ra1,ra2,dec1,dec2)
