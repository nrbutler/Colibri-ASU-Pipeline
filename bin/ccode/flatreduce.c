...
int main(int argc, char *argv[])
{
    ...
    if (argc < 9) { 
      printf("Usage: flatreduce datafile biasfile darkfile outfile biaslevel1 biaslevel2 biaslevel3 biaslevel4 \n");
      printf("\n");
    ...
    if (check && !fits_create_file(&outfptr, argv[4], &status) )
    {
      ...
      if (argc>5) biaslevel1=atof(argv[5]);
      if (argc>6) biaslevel2=atof(argv[6]);
      if (argc>7) biaslevel3=atof(argv[7]);
      if (argc>8) biaslevel4=atof(argv[8]);
